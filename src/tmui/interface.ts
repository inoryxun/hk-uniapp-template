...
export interface tmUtil {
  ...
  fetch: {
    ...
    get(
      ...
      UniApp.GeneralCallbackResult | UniApp.RequestSuccessCallbackResult
    >
    /**
     * POST请求
     * @param url 请求地址
  ...
  u: {
    ...
    scanCode(
      ...
      scanType: Array<any>
    ): Promise<UniApp.ScanCodeSuccessRes | string>
    /**
     * 设置剪切板内容。
     * @param {String} data
